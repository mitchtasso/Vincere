...
var save_file_path: String = "user://VincereSaves/Arcade/"
var save_file_name: String = "ArcadePlayerData.tres"
var direct_file_path: String = "user://VincereSaves/Arcade/"
...
var gameTimeMin: int = 0
var gameTimeSecDef: int = 0
var gameTimeMinDef: int = 0
...
func load_data():
	...
	points = playerData.kills
	gameTimeMin = playerData.gameTimeMin
	gameTimeSec = playerData.gameTimeSec
...
@onready var hscore: Label = $"../UI/DeathMenu/buttons/VBoxContainer/hscore"
...
func initial_save():
	playerData.kills = points
	playerData.gameTimeMin = gameTimeMin
	playerData.gameTimeSec = gameTimeSec
	ResourceSaver.save(playerData, save_file_path + save_file_name)

func save():
	playerData = ResourceLoader.load(save_file_path + save_file_name).duplicate(true)
	if points > playerData.kills:
		playerData.kills = points
		playerData.gameTimeMin = gameTimeMin
		playerData.gameTimeSec = gameTimeSec
		hscore.text = "NEW HIGHSCORE!"
		ResourceSaver.save(playerData, save_file_path + save_file_name)
	else:
